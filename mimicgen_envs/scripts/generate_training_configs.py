...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config_dir",
        type=str,
        default=os.path.join(mimicgen_envs.__path__[0], "exps/paper"),
    ...
    parser.add_argument(
        "--dataset_dir",
        type=str,
        default=os.path.join(mimicgen_envs.__path__[0], "../datasets"),
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default=os.path.join(mimicgen_envs.__path__[0], "../training_results"),
