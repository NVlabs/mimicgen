...
from mimicgen_envs.envs.robosuite.threading import *
from mimicgen_envs.envs.robosuite.coffee import *
from mimicgen_envs.envs.robosuite.three_piece_assembly import *
from mimicgen_envs.envs.robosuite.mug_cleanup import *
from mimicgen_envs.envs.robosuite.stack import *
from mimicgen_envs.envs.robosuite.nut_assembly import *
from mimicgen_envs.envs.robosuite.pick_place import *

try:
    from mimicgen_envs.envs.robosuite.hammer_cleanup import *
    from mimicgen_envs.envs.robosuite.kitchen import *
except ImportError:
    print("WARNING: robosuite task zoo environments not imported since robosuite task zoo is not installed!")
