...
from mimicgen_envs.models.robosuite.objects import BlenderObject, DrawerObject, LongDrawerObject
...
class MugCleanup_O2(MugCleanup_D0):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._base_mjcf_path = os.path.join(mimicgen_envs.__path__[0], "models/robosuite/assets/shapenet_core/mugs")
