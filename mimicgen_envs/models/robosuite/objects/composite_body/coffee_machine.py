...
from mimicgen_envs.models.robosuite.objects.composite_body.cup import CupObject
from mimicgen_envs.models.robosuite.objects.xml_objects import CoffeeMachineBodyObject, CoffeeMachineLidObject, CoffeeMachineBaseObject
